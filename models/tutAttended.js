...
function TutAttended(req,res){
    ...
    Subject.findById(req.params.id,function(error,foundSubject){
        if(error){
            ...
            foundSubject["attendedTut"] += 1;
            foundSubject["totalTut"] += 1;
            foundSubject["overallAttended"] += 0.5;
            foundSubject["overall"] += 0.5;
